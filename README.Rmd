...
ggm <- ggmagnify(ggp, xlim = c(.89, .99), ylim = c(-0.01, 0.2), 
                 inset_xlim = c(.65, .97), inset_ylim = c(2.3, 3.9),
                 compose = FALSE, shadow = TRUE)

ggm$inset <- ggm$inset + geom_text(data = acad, 
...
ggmalt <- ggmagnify(ggpalt, xlim = c(0.9, 1.06), ylim = c(-0.01, 0.22), 
                    inset_xlim = c(.34, .84), inset_ylim = c(2.4, 3.9), 
                    compose = FALSE, shadow = TRUE)

ggmalt$inset <- ggmalt$inset + 
...
ggmla <- ggmagnify(ggpla, xlim = c(0.94, 1.01), ylim = c(-0.01, 0.036),
                   inset_xlim = c(.2, 1) , inset_ylim = c(2.9, 4),
                   compose = FALSE, shadow = TRUE)
